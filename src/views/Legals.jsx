  ...
  return (
    <section className="legals">
      ...
      <div className="legals__container">
        <p>
          Responsable éditorial: <b>Flavien Groisillier</b>
        </p>
        <h3>Cookies :</h3>
        <p>
          Le site peut-être amené à vous demander l’acceptation des cookies pour
          des besoins de statistiques et d’affichage. Un cookie est une
        ...
        <p>
          Tout le contenu présent sur le site , incluant, de façon non
          ...
          strictement interdite sans l’accord exprès par écrit de l'un des
          responsables du site. Cette représentation ou reproduction, par
          quelque procédé que ce soit, constitue une contrefaçon sanctionnée par
        ...
        <p>
          ...
          adresse électronique, et votre numéro de téléphone. Enfin, nous
          pouvons collecter de manière automatique certaines informations vous
          concernant lors d’une simple navigation sur notre site Internet,
          notamment : des informations concernant l’utilisation de notre site,
          comme les zones que vous visitez et les services auxquels vous
          accédez, votre adresse IP, le type de votre navigateur, vos temps
          d’accès. De telles informations sont utilisées exclusivement à des
          fins de statistiques internes, de manière à améliorer la qualité des
