...
const PrivacyPolicy = () => {
  return (
    <section class="legals">
      <h2 class="legals__title">Politiques de confidentialité</h2>
      <div class="legals__container">
        <h3>Le traitement de vos données</h3>
        <p>Votre vie privée est l'une de nos priorité.</p>
        <p>Nous nous engageons à protéger la vie privée des visiteurs et des utilisateurs de nos offres en conformité avec la loi Informatique et Libertés du 6 janvier 1978 modifiée ainsi qu'avec le règlement 2016/679 du Parlement européen et du Conseil du 27 avril 2016 (RGPD)</p>
        <p>A ce titre, nous respections les principes suivants:</p>
        <ul>
          <li>- Nous collections les données dont nous avons besoin;</li>
          <li>- Nous traitons vos données pour des finalités explicites, légitimes et déterminées;</li>
          <li>- Nous conservons vos données pendant la durée nécessaire à la réalisation du traitement pour lesquelles elles ont été collectées ou, si tel est le cas, pendant la durée fixée par la loi;</li>
          <li>- Nous veillons à mettre en œuvre les mesures de sécurité adaptées afin d’assurer un niveau de protection élevé à vos données.</li>
        </ul>
        <p>Notre Politique Vie Privée a pour objectif de vous informer de manière transparente sur la façon dont nous collectons et utilisons vos données ainsi que sur vos droits.</p>
        <p>En utilisant ce site, vous déclarez accepter les termes de la présente Politique. Cette dernière est susceptible d’être modifiée à tout moment, aussi nous vous invitons à consulter cette page régulièrement.</p>
        <p>Conformément à la loi Informatique et Liberté n°78-17 modifiée et au Règlement 2016/679 du Parlement européen et du Conseil du 27 avril 2016, vous disposez d'un droit à la limitation du traitement de leurs données, d’un droit d'opposition pour motif légitime, d'accès, de portabilité, et de rectification et de suppression des données à caractère personnel vous concernant, qu'ils peuvent exercer sur simple demande envoyée à l’adresse</p>
        <h3>Cookies et autres traceurs</h3>
        <h4>Qu'est-ce qu'un cookie ?</h4>
        <p>Un cookie est un petit fichier texte susceptible d'être déposé et enregistré dans un espace du disque dur de votre terminal (ordinateur, tablette, smartphone ou tout autre appareil optimisé pour internet) lorsque vous visitez un service en ligne. Il permet à l'émetteur du cookie d'identifier le terminal dans lequel il a été enregistré et de garder en mémoire, pendant la durée de validité de ce cookie (13 mois maximum), certaines informations relatives à votre parcours afin, par exemple, de simplifier votre navigation sur un site internet, de sécuriser votre connexion ou d'adapter le contenu d'une page à vos centres d'intérêts.</p>
        <p>D'autres technologies aux fonctionnalités similaires peuvent également être utilisées notamment dans des environnements qui ne supportent pas les cookies, tels que par exemple les applications mobiles. Le terme de « cookies » utilisé dans notre Politique de confidentialité s'applique à l'ensemble de ces technologies.</p>
        <p>Ces cookies peuvent provenir de différents émetteurs :</p>
        <ul>
          <li>
            <h4>Les cookies Editeur :</h4>
            <p>Il s'agit des cookies susceptibles d'être déposés par l'Editeur sur votre terminal lors de votre navigation sur la Plateforme et/ou l'Application. Ces cookies nous permettent notamment de personnaliser, d'améliorer continuellement votre expérience sur la Plateforme et/ou l'Application.</p>
          </li>
          <li>
            <h4>Les cookies tiers :</h4>
            <p>
              Il s'agit des cookies susceptibles d'être déposés par des sociétés tierces (par exemple des régies publicitaires, des réseaux sociaux, des partenaires de l'Editeur, etc.) sur votre terminal lors de votre navigation sur la Plateforme et/ou l'Application. Ils permettent notamment à ces sociétés tierces d'identifier vos centres d'intérêt, de mesurer le trafic, et de personnaliser l'offre publicitaire qui pourrait vous être adressée sur et/ou en dehors de la Plateforme et/ou l'Application. Nous vous invitons à consulter les politiques de protection de la vie privée de ces sociétés tierces afin de prendre connaissance notamment de la durée de validité des cookies qu'ils émettent.
            </p>
          </li>
        </ul>
        <h4>2.2 Quels sont les types de cookies utilisés par l'Editeur ?</h4>
        <ul>
          <li>
            <h5>Nécessaire</h5>
            <p>
        ...
        <h4>Comment exercer vos choix depuis votre navigateur web ?</h4>
        ...
        <p>Pour exprimer ou revenir sur vos choix en matière de cookies, reportez-vous au lien correspondant à votre navigateur :</p>
        <ul>
          <li><a target="_blank" rel='noreferrer' href="https://support.google.com/chrome/answer/95647?hl=fr&amp;hlrm=en">Désactiver / Bloquer les cookies sur Google Chrome</a></li>
          <li><a target="_blank" rel='noreferrer' href="https://support.mozilla.org/fr/kb/protection-renforcee-contre-pistage-firefox-ordinateur">Désactiver / Bloquer les cookies sur Mozilla Firefox</a></li>
          <li><a target="_blank" rel='noreferrer' href="https://help.opera.com/en/latest/web-preferences/#cookies">Désactiver / Bloquer les cookies sur Opéra</a></li>
          <li><a target="_blank" rel='noreferrer' href="https://www.apple.com/legal/privacy/fr-ww/cookies/">Désactiver / Bloquer les cookies sur Safari</a></li>
          <li><a target="_blank" rel='noreferrer' href="https://support.microsoft.com/en-us/windows/delete-and-manage-cookies-168dab11-0753-043d-7c16-ede5947fc64d">Désactiver / Bloquer les cookies sur Internet Explorer</a></li>
        </ul>
        <p>
        ...
        <h4>Comment exercer vos choix depuis votre smartphone ou tablette ?</h4>
        <p>
          Pour désactiver les cookies depuis un terminal iOS, vous pouvez activer l’option « Suivi publicitaire limité ».
        </p>
        <p>
          Pour plus d’informations : <a target="_blank" rel='noreferrer' href="https://support.apple.com/fr-fr/HT202074">Consulter la page de désactivation des cookies sous iOS.</a>
        </p>
        <p>
          Pour désactiver les cookies depuis un terminal Android, vous pouvez activer l’option « Désactiver la diffusion d’annonces par centres d’intérêts ».
        </p>
        <p>
          Pour plus d’informations : <a target="_blank" rel='noreferrer' href="https://support.google.com/googleplay/answer/3405269">Consulter la page de désactivation des cookies sous Android.</a>
        </p>
      </div>
    </section>
  )
